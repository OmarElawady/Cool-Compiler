...
int attr_class::get_constructor(){
  return F_ATTR;
}

int method_class::get_constructor(){
  return F_METHOD;
}

int assign_class::get_constructor(){
  return E_ASSIGN;
}
int static_dispatch_class::get_constructor(){
  return E_STATIC_DISPATCH;
}
int dispatch_class::get_constructor(){
  return E_DISPATCH;
}
int cond_class::get_constructor(){
  return E_CONDITIONAL;
}
int loop_class::get_constructor(){
  return E_LOOP;
}
int typcase_class::get_constructor(){
  return E_TYPCASE;
}
int block_class::get_constructor(){
  return E_BLOCK;
}
int let_class::get_constructor(){
  return E_LET;
}
int plus_class::get_constructor(){
  return E_ADD;
}
int sub_class::get_constructor(){
  return E_SUB;
}
int mul_class::get_constructor(){
  return E_MUL;
}
int divide_class::get_constructor(){
  return E_DIVIDE;
}
int neg_class::get_constructor(){
  return E_NEG;
}
int lt_class::get_constructor(){
  return E_LT;
}
int eq_class::get_constructor(){
  return E_EQ;
}
int leq_class::get_constructor(){
  return E_LEQ;
}
int comp_class::get_constructor(){
  return E_COMP;
}
int int_const_class::get_constructor(){
  return E_INT;
}
int bool_const_class::get_constructor(){
  return E_BOOL;
}
int string_const_class::get_constructor(){
  return E_STRING;
}
int new__class::get_constructor(){
  return E_NEW;
}
int isvoid_class::get_constructor(){
  return E_ISVOID;
}
int no_expr_class::get_constructor(){
  return E_NO_EXPR;
}
int object_class::get_constructor(){
  return E_OBJECT;
}
...
Expression mul_class::get_e1(){
  return e1;
}

Expression mul_class::get_e2(){
  return e2;
}

Expression divide_class::get_e1(){
  return e1;
}

Expression divide_class::get_e2(){
  return e2;
}

Expression neg_class::get_e1(){
  return e1;
}

Expression lt_class::get_e1(){
  return e1;
}

Expression lt_class::get_e2(){
  return e2;
}
...
Expression leq_class::get_e1(){
  return e1;
}

Expression leq_class::get_e2(){
  return e2;
}

Expression comp_class::get_e1(){
  return e1;
}
...
Expressions static_dispatch_class::get_actual(){
  return actual;
}
...
Symbol attr_class::get_type_decl(){return this -> type_decl;}
Symbol attr_class::get_name(){return this -> name;}
Expression attr_class::get_init(){return this -> init;}
